...
with open('data\\10000Recipe.text', 'w', encoding = 'utf-8') as f:
    url='https://www.10000recipe.com/recipe/list.html?cat4=63'
    recvd=requests.get(url)
    dom = BeautifulSoup(recvd.text,'lxml')
    div = dom.find_all('li', class_ = "common_sp_list_li")

    for a in div:
        img = a.find('a')['href']
        pageUrl='https://www.10000recipe.com'+ img
        title = a.find('div', class_ = "common_sp_caption_tit line2").text
        # print(title,'\n', pageUrl, '\n')
        str = '{}\n {}\n'.format(title, pageUrl)
        print(str)
        f.write(str)
