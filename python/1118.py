...
# print(f3(a))
#
# #map(함수명, 반복가능객체) : 매개변수로 함수와 반복가능객체를 입력
# def f4(x):
#     return x * 3
# print(f4(7))
# # print(f4([1,2,3]))
...
# print(os.path.basename(f1)) #가장마지막에 있는 이름(파일이든 디렉토리든)
#
